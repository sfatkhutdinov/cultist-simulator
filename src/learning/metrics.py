...
class MetricsTracker:
    ...
    def get_aggregate_stats(self, last_n: Optional[int] = None) -> Dict[str, Any]:
        ...
        avg_survival = sum(m.survival_time_seconds for m in metrics_to_analyze) / total_sessions
        
        unique_endings = set(
            m.unique_ending_id for m in metrics_to_analyze 
    ...
    def has_improved(self, window: int = 10, baseline_window: int = 100) -> bool:
        ...
        improved_survival = recent_stats["avg_survival_time"] > baseline_stats["avg_survival_time"]
