...
def main():
    ...
    # Extract goals
    goals_parser = subparsers.add_parser("extract-goals", help="Extract goals from text")
    goals_parser.add_argument("text", help="Text to extract goals from")
    
    # Similarity
    similarity_parser = subparsers.add_parser("similarity", help="Calculate text similarity")
