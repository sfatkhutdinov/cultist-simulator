...
class ShutdownHandler:
    ...
    def register_callback(self, callback: Callable[[], None]) -> None:
        ...
        logger.debug(
            "shutdown_callback_registered", callback_count=len(self.shutdown_callbacks)
        )
    ...
    def _signal_handler(self, signum: int, frame) -> None:
        ...
        logger.info("shutdown_signal_received", signal=signal_name, signal_num=signum)
    ...
    def _shutdown(self, reason: str) -> None:
        ...
        for i, callback in enumerate(self.shutdown_callbacks):
            try:
                ...
                logger.error("shutdown_callback_failed", callback_index=i, error=str(e))
