...
from src.lib.types import Rect, DEFAULT_SCREEN_WIDTH, DEFAULT_SCREEN_HEIGHT, Point
...
def check_window_focus(window_name: str) -> bool:
    ...
    try:
        ...
        for window in window_list:
            ...
            if (
                window_name.lower() in owner_name.lower()
                or window_name.lower() in window_title.lower()
            ):
        ...
        # Window not found
        logger.debug("window_not_found", window_name=window_name)
        return False

    except Exception as e:
        logger.error("focus_check_error", window_name=window_name, error=str(e))
    ...
    try:
        ...
        for window in window_list:
            ...
            if (
                ...
                logger.info(
                    "active_window_bounds", window_name=window_name, bounds=str(bounds)
                )
        ...
        logger.error("get_bounds_error", window_name=window_name, error=str(e))
        return None
