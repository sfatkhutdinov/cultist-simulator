...
class TestActionValidation:
    ...
    def test_create_wait_action(self):
        ...
        action = Action(action_type=ActionType.WAIT, parameters={"duration": 1.5})
    ...
    def test_create_composite_action(self):
        ...
        sub_action2 = Action(action_type=ActionType.WAIT, parameters={"duration": 0.5})
    ...
    def test_action_timestamp_default(self):
        ...
        before = datetime.now()
        action = Action(action_type=ActionType.CLICK, parameters={"x": 100, "y": 200})
        after = datetime.now()
    ...
    def test_validate_drag_parameters(self):
        ...
        action = Action(
            action_type=ActionType.DRAG,
            parameters={"start_x": 100, "start_y": 200, "end_x": 300, "end_y": 400},
        )
