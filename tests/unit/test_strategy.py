...
class TestStrategyManager:
    ...
    def test_create_strategy(self, manager):
        ...
        strategy = Strategy(
            name="test_strategy", description="Test", parameters={"alpha": 0.5}
        )
    ...
    def test_list_strategies(self, manager):
        ...
        for i in range(3):
            strategy = Strategy(
                name=f"strategy_{i}", description=f"Strategy {i}", parameters={}
            )
            manager.save_strategy(strategy)
    ...
    def test_delete_strategy(self, manager):
        ...
        strategy = Strategy(
            name="to_delete", description="Will be deleted", parameters={}
        )
